...
processed_images_file_path = os.path.join(processed_dir, 'processed_images.txt')
...
def do_image_processing(image_path):
    ...
    # TODO: process images with outputs
...
def do_session_directory_processing(session_directory, session_directory_images):
    ...
    for image_raw_data in session_directory_images:
        ...
        if image_path not in processed_images:
            do_image_processing(image_path)
        else:
